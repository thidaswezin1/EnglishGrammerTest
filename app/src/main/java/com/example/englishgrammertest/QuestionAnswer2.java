...
public class QuestionAnswer2 extends Activity implements View.OnClickListener,RadioGroup.OnCheckedChangeListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuestionAndAnswer questionAndAnswer = list.get(1);
    ...
    public void onClick(View view) {
        if (answer != null) {
            Intent intent = new Intent(this, QuestionAnswer3.class);
