...
public class QuestionAnswer10 extends Activity implements View.OnClickListener,RadioGroup.OnCheckedChangeListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuestionAndAnswer questionAndAnswer = list.get(9);
