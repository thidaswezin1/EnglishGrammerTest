...
public class QuestionAnswer3 extends Activity implements View.OnClickListener,RadioGroup.OnCheckedChangeListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuestionAndAnswer questionAndAnswer = list.get(2);
    ...
    public void onClick(View view) {
        if (answer != null) {
            Intent intent = new Intent(this, QuestionAnswer4.class);
