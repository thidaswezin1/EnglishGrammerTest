...
public class QuestionAnswer6 extends Activity implements View.OnClickListener,RadioGroup.OnCheckedChangeListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuestionAndAnswer questionAndAnswer = list.get(5);
    ...
    public void onClick(View view) {
        if (answer != null) {
            Intent intent = new Intent(this, QuestionAnswer7.class);
